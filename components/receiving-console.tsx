...
function ReceiveDrawer({ suppliers, items, onClose, onDone }: { suppliers: any[]; items: any[]; onClose: () => void; onDone: () => void }) {
  ...
  return (
    <Drawer title="Receive stock" onClose={onClose} wide footer={<DrawerFooter saving={saving} onClose={pendingMsg ? onDone : onClose} onSave={save} saveLabel="Post receipt" pendingMsg={pendingMsg} />}>
