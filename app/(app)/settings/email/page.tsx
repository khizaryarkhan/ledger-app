    ...
    <div className="p-6 max-w-[720px] mx-auto">
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center gap-3">
          <h1 className="text-2xl font-semibold text-stone-900 tracking-tight">Email</h1>
          {activeLabel && (
            <span className="text-[12px] font-medium px-2.5 py-0.5 rounded-full bg-emerald-50 text-emerald-700 ring-1 ring-emerald-200">
              {activeLabel}
            </span>
          )}
        </div>
            ...
            <div className={`rounded-lg ring-1 p-4 transition-colors ${
              ...
              <div className="flex items-center gap-3">
                <div className={`w-9 h-9 rounded-lg flex items-center justify-center shrink-0 ${
                  ...
                  <Mail size={16} className={gmailStatus.connected ? "text-emerald-600" : "text-stone-400"} />
                </div>
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[12px] text-stone-500 mt-0.5 truncate">
                    {gmailStatus.connected
                      ? <><span className="font-mono text-stone-700">{gmailStatus.email}</span> · Sent mail appears in Gmail</>
            ...
            <div className={`rounded-lg ring-1 p-4 transition-colors ${
              ...
              <div className="flex items-center gap-3">
                <div className={`w-9 h-9 rounded-lg flex items-center justify-center shrink-0 ${
                  ...
                  <Mail size={16} className={msStatus.connected ? "text-emerald-600" : "text-stone-400"} />
                </div>
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                  ...
                  <p className="text-[12px] text-stone-500 mt-0.5 truncate">
                    {msStatus.connected
                      ? <><span className="font-mono text-stone-700">{msStatus.email}</span> · Sent mail appears in Outlook</>
            ...
            <div className={`rounded-lg ring-1 transition-colors ${
              ...
              <div className="flex items-center gap-3 p-4">
                ...
                <button
                  ...
                  className="shrink-0 flex items-center gap-1 text-[12px] font-medium text-stone-600 hover:text-stone-900 transition-colors ml-2"
                >
              ...
              {/* Inline SMTP form */}
              {showSmtpForm && (
                <div className="border-t border-stone-200 px-4 pb-5 pt-4 space-y-3">
                  ...
                  {testResult && (
                    <div className={`text-xs px-3 py-2 rounded-md ${testResult.ok ? "bg-emerald-50 text-emerald-700" : "bg-rose-50 text-rose-700"}`}>
