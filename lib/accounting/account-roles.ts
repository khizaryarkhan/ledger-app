...
export const ROLES: Record<AccountRole, RoleMeta> = {
  ...
  GRNI:                    { role: "GRNI",                    section: "Purchasing",    kind: "current_liability", label: "Goods received not invoiced", purpose: "Purchase and subcontract receipts awaiting the bill",     defaultName: "Goods Received Not Invoiced" },
